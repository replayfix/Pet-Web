...
export default function ProductCard({ product }) {
  ...
  return (
    <div className="card card-hover flex flex-col h-full overflow-hidden bg-white relative group">
      ...
      <div className="p-5 flex flex-col flex-1 justify-between gap-3">
        ...
        <div className="pt-3 border-t border-slate-100 flex items-center justify-between mt-auto mb-3.5">
