  ...
  return createPortal(
    <div className="fixed inset-0 z-[1100] bg-slate-900/80 backdrop-blur-sm overflow-y-auto animate-fade-in print:p-0 print:bg-white print:static">
      <div className="flex min-h-full items-center justify-center p-4 sm:p-6 sm:py-8 print:p-0 print:block">
        ...
        <div className="bg-white max-w-[480px] w-full rounded-2xl shadow-2xl border border-slate-200 overflow-hidden flex flex-col max-h-[80vh] text-left print:max-h-none print:shadow-none print:border-none print:max-w-full print:rounded-none animate-zoom-in">
