          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2">
                <h3 className="font-extrabold text-base leading-tight">Previsualización del Pedido</h3>
                <span className="bg-amber-400 text-slate-900 font-mono font-black text-[11px] px-2 py-0.5 rounded-md">
                  {orderNum}
                </span>
              </div>
              <p className="text-xs text-slate-400 font-medium flex items-center gap-1 mt-0.5">
                <Calendar size={13} />
                <span>Emitido: {formatDate(order.timestamp)}</span>
              </p>
            </div>
          </div>
          <button 
